...
public class GameManager {
    ...
    //fixme: Move this logic to an interface which the modules can implement
    ...
    public void kill(@NotNull CytosisPlayer dead, @Nullable CytosisPlayer killer, @NotNull RegistryKey<DamageType> damageType) {
